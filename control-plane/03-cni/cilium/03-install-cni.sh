...
cilium install cilium cilium/cilium --namespace kube-system \
	...
	--set skipRedirectFromBackend=true \
	--set redirectFrontend.serviceMatcher.serviceName=true \
	--set redirectFrontend.serviceMatcher.namespace=kube-system \
	--set redirectBackend.localEndpointSelector.matchLabels.k8s-app=node-local-dns \
